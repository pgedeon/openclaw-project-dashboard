...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    if (url === '/operations' || url === '/operations/') {
      sendFile(res, 'dashboard/operations.html');
      return;
    }

    // Serve workflows page
    if (url === '/workflows' || url === '/workflows/') {
      sendFile(res, 'dashboard/workflows.html');
      return;
    }
    ...
    // Serve skills-tools page
    if (url === '/skills-tools' || url === '/skills-tools/') {
      sendFile(res, 'dashboard/skills-tools.html');
      return;
    }
